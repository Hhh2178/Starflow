...
import { getSystemOverview } from "@/services/adminSettings";
import { sendAdminSettingsError } from "@/services/adminSettingsHttp";
import type { AuthUser } from "@/types/auth";

type GetOverview = (actor: AuthUser) => Promise<unknown>;

export function createSystemOverviewRouter(getOverview: GetOverview = getSystemOverview) {
...
export default createSystemOverviewRouter();
